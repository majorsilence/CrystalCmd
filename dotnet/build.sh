...
docker build --progress plain --no-cache --build-arg A_CRYSTALCMD_VERSION="$crystal_cmd_version" -f Dockerfile.crystalcmd -t majorsilence/dotnet_framework_wine_crystalcmd -m 4GB .
