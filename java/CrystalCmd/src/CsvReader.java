 ...
 */
public class CsvReader implements SimpleRowSource {
     ...
     */
    public ResultSet read(String inputFileName,
                          String charset) throws SQLException {
     ...
     * @return the result set
     */
    public ResultSet read(Reader reader) throws IOException {
        init(null, null);
        this.input = reader;
        return readResultSet(null);
    }
    ...
    private void readHeaderTypes() throws IOException {
        // Types.VARCHAR
        ...
        while (true) {
            ...
            if (v == null) {
                ...
                if (v.isEmpty()) {
                    ...
                    v = StringUtils.toLowerEnglish(v);
        ...
        columnTypes = list.toArray(new Integer[0]);
    }
